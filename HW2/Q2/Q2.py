# https://github.com/qw2208/disparity-matching/blob/master/projectHomeworkFinal/stereo-matching.py
...
def disparity_map(img_left, img_right, disp_left, block_size):
...
def Art_Pair_SSD(img_left, img_right, disp_left):
    """ -------------------SSD, window=3------------------- """
    start_time0 = time()
    d_map0 = disparity_map(img_left, img_right, disp_left, 3)
    ...
    """ -------------------SSD, window=9------------------- """
    start_time1 = time()
    d_map1 = disparity_map(img_left, img_right, disp_left, 9)
    ...
    """ -------------------SSD, window=15------------------- """
    start_time2 = time()
    d_map2 = disparity_map(img_left, img_right, disp_left, 15)
